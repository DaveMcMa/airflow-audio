...
def enhanced_voice_activity_detection(audio, sr, frame_duration=20):
    """Enhanced VAD using webrtcvad with fallback to pure Python"""
    import numpy as np
    ...
    try:
        ...
        logger.warning("webrtcvad not available, falling back to pure Python VAD")
        
        # Fallback: Pure Python VAD implementation
        import librosa
